...
const AdvancedSocialFeatures = {
        ...
        async distributeChallengeRewards(challenge) {
            ...
            for (const userId of participants) {
                try {
                    ...
                    console.error(`Error distributing reward to ${userId}:`, error);
                }
            }
        },
    ...
    teamGoals: {
        ...
        async updateTeamGoalProgress(goalId, progress) {
            try {
                ...
                console.error('Error updating team goal progress:', error);
                throw error;
            }
        },
        ...
        async distributeTeamGoalRewards(goalData) {
            ...
            for (const memberId of team.members) {
                try {
                    ...
                    console.error(`Error distributing team reward to ${memberId}:`, error);
                }
            }
        },
        ...
        async inviteToTeam(teamId, userEmail) {
            try {
                ...
                console.log(`Team invitation sent to ${userEmail}`);
    ...
    peerAccountability: {
        ...
        async sendAccountabilityRequest(partnerId, message) {
            try {
                ...
                // Send notification
                console.log(`Accountability request sent to user ${partnerId}`);
                
                return request;
            } catch (error) {
                console.error('Error sending accountability request:', error);
                throw error;
            }
        },
        ...
        async acceptAccountabilityRequest(requestId) {
            try {
                ...
                console.error('Error accepting accountability request:', error);
                throw error;
            }
        },
    ...
    async init() {
        console.log('🌐 Initializing Advanced Social Features...');
